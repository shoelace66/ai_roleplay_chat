                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildNumberSetting(
                      ...
                      onChanged: (v) => setState(() {
                        _settings =
                            _settings.copyWith(lruKeywordMatchWeight: v);
                      }),
                    ),
                    _buildNumberSetting(
                      title: '事件-事件关联权重',
                    ...
                    _buildNumberSetting(
                      ...
                      onChanged: (v) => setState(() {
                        _settings = _settings.copyWith(
                            lruEventBelongingKeywordWeight: v);
                      }),
                    ),
                    _buildNumberSetting(
                      title: '事件-物品关联（普通）权重',
                      ...
                      onChanged: (v) => setState(() {
                        _settings = _settings.copyWith(
                            lruEventBelongingNormalWeight: v);
                      }),
                    ),
                    _buildNumberSetting(
                      ...
                      onChanged: (v) => setState(() {
                        _settings =
                            _settings.copyWith(lruEventSettingKeywordWeight: v);
                      }),
                    ),
                    _buildNumberSetting(
                      title: '事件-设定关联（普通）权重',
